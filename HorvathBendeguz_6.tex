...
%$$\langle n \rangle = \sum^{\infty}_{n}nP_n$$
%Legyen inkább 
%$$\Phi(s) = \ln(G(s)) = \ln(\sum^\infty_{n=0}e^{-sn}P_n) = \ln{\sum^\infty_{n=0}(e^{-sn}\big[P_0 + \sum^\infty_{n=1}\prod^{n}_{k=0}\frac{\lambda_{k-1}}{\mu_k}\big ])}$$
